...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-C5DtGLZc.mjs");
...
const manifest = {
  "d5d1516df3b15f9b01e23ed40cda22b58728aafe46e1ea4dd526f9df75ede78c": {
    ...
    importer: () => import("./booking.functions-CEDU0BI_.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-DwOibJWV.mjs").then((n) => n.r),
    import("./start-eAzigog3.mjs"),
